...
//GetWeatherByCityCoordinates You can call By geographic coordinates.
//lat, lon coordinates of the location of your interest.
//Units possible values are: metric, imperial or empty string.
//Lang possible values are: ar, bg, ca, cz, de, el, en, fa, fi, fr, gl, hr, hu, it,
//ja, kr, la, lt, mk, nl, pl, pt, ro, ru, se, sk, sl, es, tr, ua, vi, zh_cn, zh_tw
func (c *Client) GetWeatherByCityCoordinates(lat, lon float64, units, lang string) (jsonString string, err error) {
	params := url.Values{}
